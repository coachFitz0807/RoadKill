...
public class Robot extends IterativeRobot {
    ...
    public void disabledInit () {
        System.out.println("Robot.disabledInit.  About to construct Drive1.");
        d1 = new Drive1();
        d2 = new Drive2();
    }
	...
	// This makes sure that the autonomous stops running when
        ...
        System.out.println("about to start Drive1 and Drive2 commands");
        d1.start();
        d2.start();
    ...
    public void teleopPeriodic() {
        System.out.println("Robot.teleopPeriodic. About to call Scheduler.getInstance().run()");
        Scheduler.getInstance().run();
    }
    /**
