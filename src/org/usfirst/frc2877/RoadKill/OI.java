...
public class OI {
    ...
    public OI() {
        ...
        joystickButton1.whileHeld(new SetSpike());
	    
        // SmartDashboard Buttons
        SmartDashboard.putData("Autonomous Command", new AutonomousCommand());
        SmartDashboard.putData("SetSpike", new SetSpike());
        SmartDashboard.putData("Drive", new Drive());
        System.out.println("OI constructor. About to construct Drive1.");
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        System.out.println("OI constructor.  Just before joystickButton2.whenPressed()");
	joystickButton2.whenPressed(new Drive1());
        
        joystickButton3 = new JoystickButton(joystick1, 3);
        System.out.println("OI constructor. Just before joystickButton3.whenPressed()");
        joystickButton3.whenPressed(new Drive2());
    }
